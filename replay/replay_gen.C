...
void replay_gen(UInt_t runnum=10491, Long_t nevents=-1, Long_t firstevent=0, const char *fname_prefix="e1209016", UInt_t firstsegment=0, UInt_t maxsegments=1, Int_t pedestalmode=0, Int_t cmplots=1)
{
  ...
  SBSGEMSpectrometerTracker *sbsgem = new SBSGEMSpectrometerTracker("gems", "SBS GEM data" );
  bool pm = (pedestalmode != 0 );

  ( static_cast<SBSGEMTrackerBase *> (sbsgem) )->SetPedestalMode( pm );
